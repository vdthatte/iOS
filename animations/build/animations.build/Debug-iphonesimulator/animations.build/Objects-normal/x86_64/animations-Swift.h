...
SWIFT_CLASS("_TtC10animations11AppDelegate")
...
SWIFT_CLASS("_TtC10animations25NavigationTransitionOneVC")
@interface NavigationTransitionOneVC : UIViewController
...
SWIFT_CLASS("_TtC10animations23TransitionDestinationVC")
@interface TransitionDestinationVC : UIViewController
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10animations17TransitionManager")
...
SWIFT_CLASS("_TtC10animations18TransitionManager2")
@interface TransitionManager2 : NSObject <UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate>
@property (nonatomic) BOOL pre;
- (id <UIViewControllerAnimatedTransitioning> __nullable)animationControllerForPresentedController:(UIViewController * __nonnull)presented presentingController:(UIViewController * __nonnull)presenting sourceController:(UIViewController * __nonnull)source;
- (id <UIViewControllerAnimatedTransitioning> __nullable)animationControllerForDismissedController:(UIViewController * __nonnull)dismissed;
- (void)animateTransition:(id <UIViewControllerContextTransitioning> __nonnull)transitionContext;
...
SWIFT_CLASS("_TtC10animations12TransitionVC")
@interface TransitionVC : UIViewController
@property (nonatomic) BOOL theBool;
@property (nonatomic, readonly) TransitionManager * __nonnull transitionManager;
@property (nonatomic, readonly) TransitionManager2 * __nonnull trans;
- (IBAction)unwindToViewController:(UIStoryboardSegue * __nonnull)sender;
- (IBAction)show:(id __nonnull)sender;
- (IBAction)button:(id __nonnull)sender;
...
SWIFT_CLASS("_TtC10animations14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)animate:(id __nonnull)sender;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
